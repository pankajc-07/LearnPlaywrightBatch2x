...
Short answer: A variable holds a reference to the object, not the object itself. const locks the binding (which object the variable points to), not the object's contents. Since the reference almost never needs reassignment, const is the correct default.
...
One gotcha: const is shallow. It does not freeze the object. Use Object.freeze(obj) to prevent mutation of contents.
